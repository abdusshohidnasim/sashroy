...
class LoginScreen
                          ...
                          children: [
                              ...
                              children: [
                                TextSpan(
                                  ...
                                  recognizer: TapGestureRecognizer()
                                    ..onTap = () {
                                      NavigationService.navigateTo(Routes.forgotPasswordEmailScreen);
                                    },
                                ),
                              ],
                            )),
                            ...
                            AnimatedBuilder(
                              ...
                              builder: (context, child) {
                                final emailText = loginreadbloc.emailController.text;
                                final passwordText = loginreadbloc.passwordController.text;

                                final isEnabled = emailValidator(emailText) == null && passwordValidator(passwordText) == null;

                                return CustomButton(
                                  isLoading: state.status == LoginStatus.loading,
                                  bgColor: isEnabled ? AppColors.c1A1A1A : AppColors.cCCCCCC,
                                  onTap: () {
                            ...
                            CustomButton(
                              ...
                              textStyle: TextFontStyle.textStyle16C1A1A1ADGSM500.copyWith(fontWeight: FontWeight.w700),
                            ),
  ...
  Widget
      _buildTextforomfileName(String text) {
    return Text(text,
        style: TextFontStyle.textStyle16CFFFFFFGSM500.copyWith(color: AppColors.c1A1A1A));
  }
}
